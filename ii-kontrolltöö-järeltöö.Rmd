...
colnames(dataframeForFalling) = c("t plussmiinus .05 s", "h plussmiinus 5 % näidust (m)")

```

a) Koostada antud andmete põhjal graafik koos veakastidega

b) Arvestades, et kõrguse ja kukkumise aja vahel on seos h=gt^2/2, leida õige funktsioon ning vastava funktsiooni parameetrid.
